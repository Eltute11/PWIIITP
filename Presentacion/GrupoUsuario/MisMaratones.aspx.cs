...
namespace Presentacion.GrupoUsuario
{
    public partial class MisMaratones : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           sdsUsuarioMaratonesPendiente.SelectCommand = "SELECT A.Nombre, A.Fecha, A.Km, A.ID FROM Maraton AS A INNER JOIN Maraton_Usuario AS B ON A.ID = B.MaratonID WHERE (B.UsuarioID = " + usuario.ID + ")";
